...
#
#     -w       wait indefinately for the files generated by split (containing lines from stdin) to appear in $tmpDir. Normally, forkrun will wait ~5 seconds (4096 `sleep 0.001` calls)
