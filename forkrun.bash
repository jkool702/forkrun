...
#
# 
# ISSUE: in some situations, using the '-k' flag *may* cause forkrun to add a few (1 - 3) extra newlines after the end of the "normal" output
#
# CAUSE: TBD
#
# WORKAROUND: filter out these lines by piping forkrun's output to something. e.g., ig you have 100 inputs and each of these produces exactly 1 output line and forkrun is giving 102 lines (with the last 2 being blank), do
#              <...> | forkrun <...> | head -n 100
#
