// forkrun_ring.c v8.47 (Golden Master + FD Caching)
// ======================================================================================
// CHANGES vs v8.46:
// 1. OPTIMIZATION: Added FD Caching to Worker Thread-Local Storage.
//    - 'ring_worker inc [FD]' now accepts an optional FD to cache.
//    - Eliminates 'atoi' overhead for FD on every 'ring_claim' call.
// 2. OPTIMIZATION: Streamlined 'ring_claim' parsing.
//    - Supports 'ring_claim' (no args) -> uses cached FD + "REPLY".
//    - Supports 'ring_claim VAR' -> uses cached FD.
//    - Preserves legacy 'OFF VAR FD' support dynamically.
// ======================================================================================
