// forkrun_ring.c v8.33
// ======================================================================================
// CHANGES vs v8.32:
// 1. Removed 'len_ring'.
// 2. Updated Scanner to write offset[N+1] (next start) when publishing Batch N.
// 3. Updated Claim to calculate BYTES via (offset[N+cnt] - offset[N]).
// 4. Preserved ring_pipe and ring_splice (with auto-resize) from v8.32.
// ======================================================================================
