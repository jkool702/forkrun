...
This harness is the project's evidence layer for the Python frontend (localization, honest claims, positioning). It is not a decision instrument: the proceed decision is unconditional and recorded in dev/supervisor/STAGE0_AMENDMENT.md.
